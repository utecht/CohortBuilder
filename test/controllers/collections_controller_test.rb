...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference("Collection.count") do
      post collections_url, params: { collection: { name: @collection.name, nbia_link: @collection.nbia_link } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { name: @collection.name, nbia_link: @collection.nbia_link } }
