...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference("Concept.count") do
      post concepts_url, params: { concept: { definition: @concept.definition, label: @concept.label, obo_class: @concept.obo_class, rdf_template: @concept.rdf_template } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { definition: @concept.definition, label: @concept.label, obo_class: @concept.obo_class, rdf_template: @concept.rdf_template } }
